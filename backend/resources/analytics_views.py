...
class AdminDashboard(Resource):
    ...
    def get(self):
        ...
        try:
            start_date = datetime.strptime(request.args.get('start_date'), '%d/%m/%Y') if 'start_date' in request.args else None
            end_date = datetime.strptime(request.args.get('end_date'), '%d/%m/%Y') if 'end_date' in request.args else None
