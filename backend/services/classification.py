...
# load the model
model = joblib.load("F:/DEPI/Project/complaint_app/services/classification_models/SGD.pkl")

# Load TF-IDF Vectorizer
tfidf_vectorizer = joblib.load("F:/DEPI/Project/complaint_app/services/classification_models/tfidf_vectorizer.pkl")
